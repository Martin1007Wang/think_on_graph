...
if __name__ == "__main__":
    ...
    paths_to_evaluate: List[str] = [
        "/mnt/wangjingxiong/think_on_graph/results/IterativeReasoning_v10/RoG-webqsp/Llama-3.1-8B-Instruct/deepseek-chat/iterative-rounds2-topk5/predictions.jsonl",
