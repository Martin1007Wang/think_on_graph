...
def main():
    ...
    parser.add_argument("--predict_file_path", type=str, default="/mnt/wangjingxiong/think_on_graph/results/all_result/RoG-cwq/mpo/deepseek-chat/iterative-rounds2-topk3/predictions.jsonl", help="JSONL 格式的预测文件路径。")
