...
SPLIT="test"
MODEL_NAME="GCR-lora-dpo_v3_with_label-Llama-3.1-8B-Instruct"
MODEL_PATH="/mnt/wangjingxiong/think_on_graph/dpo_models_v3/GCR-lora-dpo_v3_with_label-Llama-3.1-8B-Instruct/merged_model"
