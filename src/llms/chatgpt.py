...
def get_token_limit(model='gpt-4'):
    ...
    elif model in ['gpt-4o', 'gpt-4o-mini', 'gpt-4-turbo','deepseek-v3','deepseek-r1']:
        num_tokens_limit = 64000
    elif model in ['deepseek-r1-70b','deepseek-r1-32b','deepseek-r1-14b','deepseek-r1-8b','deepseek-r1-7b','deepseek-r1-1.5b']:
